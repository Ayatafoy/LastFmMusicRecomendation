...
public class MusicRecomendManager {

    public static HashMap<String, HashMap<String, ArrayList<MyPair>>> friends = new HashMap<>();
    public static HashMap<String, HashMap<String, Double>> friendsTrackListRange = new HashMap<>();
    public static HashMap<String, HashMap<String, Double>> friendsArtistCount = new HashMap<>();
    public static HashMap<String, HashMap<Integer, Double>> friendsGenderCount = new HashMap<>();
    public static HashMap<String, ArrayList<MyPair>> friendsListsArr = new HashMap<>();
    public static ArrayList<MyPair<MyPair>> result = new ArrayList<>();
    private static Connection _connection;

    public MusicRecomendManager(Connection connection) throws SQLException, ParseException, IOException, URISyntaxException{
    ...
    public static class MyPair<T> extends Pair {
        private T left;
        private T right;
    ...
    public static HashMap<String, ArrayList<MyPair>> normGender(HashMap<String, ArrayList<MyPair>> audios) {
        int x;
    ...
    public static HashMap<Integer, Double> countGender(HashMap<String, ArrayList<MyPair>> audios) {
    ...
    public static HashMap<String, Double> countArtist(HashMap<String, ArrayList<MyPair>> audios) {
    ...
    public static <T> ArrayList<MyPair> Sort(HashMap<T, Double> audios) {
    ...
    public static HashMap<String, Double> range(HashMap<String, HashMap<String, Double>> map, String myName) {
    ...
    public static ArrayList<MyPair<MyPair>> recTrack(ArrayList<MyPair> sortTrackList, HashMap<Integer, Double> myMap1, HashMap<String, Double> myMap2, String userId) {
    ...
    public static ArrayList<String> searchAction(String userId) throws URISyntaxException, SQLException, ParseException, IOException {
